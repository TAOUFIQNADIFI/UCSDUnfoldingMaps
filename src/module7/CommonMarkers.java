...
public abstract class CommonMarkers extends SimplePointMarker {

	// Records whether this marker has been clicked (most recently)
	protected boolean clicked = false;
	
	public CommonMarkers(Location location) {
		super(location);
	}
	
	public CommonMarkers(Location location, java.util.HashMap<java.lang.String,java.lang.Object> properties) {
