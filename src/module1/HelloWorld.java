...
public class HelloWorld extends PApplet
{
	...
	/** The map you will use to display your home town (EAST BOSTON, MA) */ 
	UnfoldingMap map2;

	public void setup1() {
		size(10000, 1400, P2D);  // Set up the Applet window to be 800x600
		...
		map1 = new UnfoldingMap(this, 50, 50, 500, 500, provider);
	...
	public void setup() {
		...
		map2 = new UnfoldingMap(this, 250, 50, 200, 200, provider1);
