 ...
 *
 */
public abstract class CommonMarker1 extends SimplePointMarker {

	// Records whether this marker has been clicked (most recently)
	protected boolean clicked = false;
	
	public CommonMarker1(Location location) {
		super(location);
	}
	
	public CommonMarker1(Location location, java.util.HashMap<java.lang.String,java.lang.Object> properties) {
